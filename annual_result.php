    ...
    <div class='container' id='result_page'>
        ...
        <div class='row'>
            ...
            <div class='col-md-8 col-sm-8 col-xs-8'>
                ...
                <h5 class='text-center'><b><?php echo $result_term; ?> Report Sheet for <?php echo $result_session; ?>
                        Session</b></h5>
                <br />
                <br />
                <div class='row'>
                ...
                <div class='col-md-5 col-xs-5'>
                    <div class='panel panel-default'>
                        <div class='panel-body'>
                            <p class='grade'><b>Position in Class:</b>
                                <?php echo $position_in_class; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <b>Number in Class:</b> <?php echo $number_in_class; ?></p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <br />
        <button type='button' class='btn btn-default noprint' onclick='window.print()' value='print a div!'><span
