            ...
            <div class='row'>
                ...
                <div class='col-md-6'>
                    ...
                    if (isset($_POST['control_access_btn'])) {
                        // Pass both $connection and the input field value to inject_checker
                        $control_access = inject_checker($connection, strtolower($_POST['control_access']));

                        if (empty($control_access)) {
                            echo "<p class='text-danger'><b>Please This Field cannot be empty</b></p>";
                        } else {
                            // Check if control access record exists
