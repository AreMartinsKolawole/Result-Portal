            ...
            <div class='row header noprint'>
                ...
                <div class='col-md-6 col-sm-6 col-xs-6'>
                    <?php
						...
						?>
                    <h2 class='text-center'><span class='glyphicon glyphicon-education'></span> Admin - SURE FOUNDATION COMPREHENSIVE COLLEGE</h2>
                ...
                <div class='col-md-3 col-sm-3 col-xs-3 logout'>
                    ...
                    <h4 class='text-right'><a href='staff_dashboard.php?logout'><span
        ...
        <section class='row'>
            ...
            <div class='col-md-2 col-sm-2 side_nav noprint'>
                <ul class="nav nav-pills nav-stacked">
                    <li role="presentation" class="active"><a href="staff_dashboard.php?view_profile"><span
                                class='glyphicon glyphicon-user'></span> View Profile</a></li>
                    <li role="presentation"><a href="staff_dashboard.php?administratives"><span
                                class='glyphicon glyphicon-tasks'></span> Administratives</a></li>
                    <li role="presentation"><a href="staff_dashboard.php?register_new_student"><span
                                class='glyphicon glyphicon-education'></span> Register New Student</a></li>
					<li role="presentation"><a href="staff_dashboard.php?register_new_teacher"><span
                                class='glyphicon glyphicon-log-in'></span> Register New Teacher</a></li>
                    <li role="presentation"><a href="staff_dashboard.php?students_reg_no"><span
                                class='glyphicon glyphicon-eye-open'></span> My Students</a></li>
                    <li role="presentation"><a href="staff_dashboard.php?print_student_slip"><span
                                class='glyphicon glyphicon-print'></span> Print Student Slip</a></li>
                    <li role="presentation"><a href="staff_dashboard.php?manage_subjects"><span
                                class='glyphicon glyphicon-blackboard'></span> Manage Subjects</a></li>
                    <li role="presentation"><a href="staff_dashboard.php?register_subjects"><span
                                class='glyphicon glyphicon-open'></span> Register Subjects</a></li>
                    <li role="presentation"><a href="staff_dashboard.php?upload"><span
                                class='glyphicon glyphicon-cloud-upload'></span> Result Upload</a></li>
                    <li role="presentation"><a href="staff_dashboard.php?publish_result"><span
                                class='glyphicon glyphicon-new-window'></span> Publish Result</a></li>
                    <li role="presentation"><a href="staff_dashboard.php?promote_students"><span
                                class='glyphicon glyphicon-export'></span> Promote Students</a></li>
                    <li role="presentation"><a href="staff_dashboard.php?check_result"><span
                                class='glyphicon glyphicon-send'></span> Check Student Result</a></li>
                    <li role="presentation"><a href="staff_dashboard.php?register_new_user"><span
                                class='glyphicon glyphicon-log-in'></span> Register New User</a></li>
                    <li role="presentation"><a href="staff_dashboard.php?logout"><span
            ...
            <div class='col-md-10 col-sm-10'>
                ...
                <?php
							  ...
							  if($run_query == true){
								...
								if(isset($_POST['add_session_btn'])){
									...
									if(empty($add_session)){
										...
										$add_session = mysqli_real_escape_string($connection, $add_session);
								...
								if(isset($_POST['add_class_btn'])){
									...
									if(empty($add_class)){
										...
										$add_class = mysqli_real_escape_string($connection, $add_class);
					...
					elseif(isset($_GET['register_new_user'])){
						...
						<div class='col-md-10' id='log'>";
							...
							<div class='panel panel-primary'>
								...
								<div class='panel-body'>
									<p class='text-warning'><b>NOTE: To Register a new Admin, You Need a Control Access. Please Contact Our User Support ...</b></p>
					...
					elseif(isset($_GET['register_new_teacher'])){
						require_once("staff_dashboard_processor.php");
						echo"
						<div class='col-md-10' id='log'>";
							foreach($error as $msg_failed){
							...
							<div class='panel panel-primary'>
								<div class='panel-heading'>
									<h3 class='log-text'>Register New teacher</h3>
								</div>
									
								<div class='panel-body'>
									<p class='text-warning'><b>NOTE: To Register a 	Teacher, You Need a Control Access. Please Contact Our teacher Support ...</b></p>
									<form class='' id='login' method='POST' action='staff_dashboard.php?register_new_teacher'>
										<div class='input-group'>
											<span class='input-group-addon' id='basic-addon2'>Control Access</span>
											<input type='password' name='control_access' placeholder='Type Admin Control Access to enable you create a new admin! ...' class='form-control' />
										</div>
										...
										<div>
											<label class='checkbox-inline'>
												<input type='radio' name='teacher_title' id='title1' value='mr' checked /> Mr
											</label>
											
											<label class='checkbox-inline'>
												<input type='radio' name='teacher_title' id='title2' value='mrs' /> Mrs
											</label>
											
											<label class='checkbox-inline'>
												<input type='radio' name='teacher_title' id='title3' value='miss' /> Miss
											</label>
										</div>
										<br />
										<div class='input-group'>
											<span class='input-group-addon' id='basic-addon2'>Fullname</span>
											<input type='text' placeholder='Type Your Fullname' class='form-control' name='teacher_fullname' />
										</div>
										<br />
										
										<div class='input-group'>
											<span class='input-group-addon' id='basic-addon2'>Home Address:</span>
											<textarea rows='3' name='teacher_address' required class='form-control' placeholder='...' aria-describedby='basic-addon2'></textarea>
										</div>
										<br/>
										
										<div class='input-group'>
											<span class='input-group-addon' id='basic-addon2'>Phone</span>
											<input type='text' placeholder='Type Phone Number' class='form-control' name='teacher_phone' />
										</div>
										<br />
										
										<div class='input-group'>
											<span class='input-group-addon' id='basic-addon2'>State:</span>
											<select class='form-control' name='teacher_state'>
												<option selected >"; echo $select; echo "</option>";
										...
										<div class='input-group'>
											<span class='input-group-addon' id='basic-addon2'>LGA:</span>
											<textarea rows='' name='teacher_lga' required class='form-control' placeholder='...' aria-describedby='basic-addon2'></textarea>
										</div>
										<br/>
										
										<div class='input-group'>
											<span class='input-group-addon' id='basic-addon2'>Nationality:</span>
											<select class='form-control' name='teacher_nationality'>
												<option selected >"; echo $select; echo "</option>
												<option>Nigerian</option>
												<option>Non-nigerian</option>
											</select>
										...
										<div class='input-group'>
											<span class='input-group-addon' id='basic-addon2'>Email</span>
											<input type='text' placeholder='Type Email Address' class='form-control' name='teacher_email' />
										</div>
										<br />
										
										<div class='input-group'>
											<span class='input-group-addon' id='basic-addon2'>Password</span>
											<input type='password' placeholder='Type password' class='form-control' name='teacher_password1' />
										</div>
										<br />
										
										<div class='input-group'>
											<span class='input-group-addon' id='basic-addon2'>Confirm Password</span>
											<input type='password' placeholder='Retype Password' class='form-control' name='teacher_password2' />
										</div>
										<br />
										<p id='btnsubmit'><input type='submit' name='teacher_reg_btn' id='submit' value='Register' class='btn btn-large btn-success login_btn text-center' /></p>
									</form>
									<button type='button' class='btn btn-default' onclick='window.print()' value='print a div!'><span class='glyphicon glyphicon-print'></span> Print</button>
								</div>
